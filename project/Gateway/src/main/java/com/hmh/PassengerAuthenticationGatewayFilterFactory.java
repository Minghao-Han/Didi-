...
@Component
public class PassengerAuthenticationGatewayFilterFactory extends AbstractGatewayFilterFactory<PassengerAuthenticationGatewayFilterFactory.Config> {

    private static final String AUTH_HEADER_NAME = "TOKEN";

    public PassengerAuthenticationGatewayFilterFactory() {
        super(Config.class);
    }
    ...
    public GatewayFilter apply(Config config) {
        return (exchange, chain) -> {
            ...
            /** exclude some paths */
            if (requestPath.equals("/test")||requestPath.equals("/register")||requestPath.equals("/login"))
